...
for iter = 1:maxIter
    ...
    [t_r, x_r, t_0, x_0, t_L, x_L, t_ic, x_ic] = sample_training_data(params, iter, net);
    ...
    % Progress display with peak protection monitoring
    if mod(iter,100)==0 || iter==1
        fprintf('Iter %4d | Loss = %.3e | lr = %.1e', iter, loss_history(iter), lr);
